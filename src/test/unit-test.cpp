...
void test_rs_unicode_string_comparison_common_prefix_suffix();
...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_unicode_string_comparison_common_prefix_suffix, "test_rs_unicode_string_comparison_common_prefix_suffix");
