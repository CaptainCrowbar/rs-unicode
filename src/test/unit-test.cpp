...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_unicode_character_properties_normalization_quick_check, "test_rs_unicode_character_properties_normalization_quick_check");
    ...
    call_me_maybe(test_rs_unicode_regex_match_iterator, "test_rs_unicode_regex_match_iterator");
    ...
    call_me_maybe(test_rs_unicode_string_comparison_dynamic_sorting, "test_rs_unicode_string_comparison_dynamic_sorting");
    call_me_maybe(test_rs_unicode_string_comparison_static_sorting, "test_rs_unicode_string_comparison_static_sorting");
    call_me_maybe(test_rs_unicode_string_comparison_common_prefix_and_suffix, "test_rs_unicode_string_comparison_common_prefix_and_suffix");
    ...
    call_me_maybe(test_rs_unicode_string_manipulation_cat_normalized, "test_rs_unicode_string_manipulation_cat_normalized");
    call_me_maybe(test_rs_unicode_string_manipulation_fold_whitespace, "test_rs_unicode_string_manipulation_fold_whitespace");
    ...
    call_me_maybe(test_rs_unicode_string_properties_normalization, "test_rs_unicode_string_properties_normalization");
