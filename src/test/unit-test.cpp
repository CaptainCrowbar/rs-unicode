...
int main(int argc, char** argv) {
    ...
    call_me_maybe(test_rs_unicode_character_properties_xid_continue, "test_rs_unicode_character_properties_xid_continue");
    call_me_maybe(test_rs_unicode_character_properties_xid_start, "test_rs_unicode_character_properties_xid_start");
    ...
    call_me_maybe(test_rs_unicode_enum, "test_rs_unicode_enum");
    call_me_maybe(test_rs_unicode_enum_bitmask, "test_rs_unicode_enum_bitmask");
    call_me_maybe(test_rs_unicode_format_concepts, "test_rs_unicode_format_concepts");
    call_me_maybe(test_rs_unicode_format_automation, "test_rs_unicode_format_automation");
